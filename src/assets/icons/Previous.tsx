...
const Previous: FunctionComponent<Props> = ({ svg }) => (
    <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width={svg.width} height={svg.height} fill="none" viewBox="0 0 24 24">

...
const AboutMe:FunctionComponent = () => (
    <section id="aboutMeSection" className="flex flex-col md:flex-row md:w-5/6 items-center justify-center gap-9 md:gap-[110px] mx-auto py-10 saturate-0 hover:filter-none transition-all duration-300 ease-in">
        ...
        <div className="mx-10 md:mx-0 md:w-2/5">

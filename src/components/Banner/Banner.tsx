...
const Banner = () => (
    <div id='banner' className="mt-[6rem] mb-10 h-[70vh] md:h-[80vh] relative pt-9 after:h-[20vh] lg:after:h-[10vh] xl:after:h-[20vh]">
        ...
        <div className='absolute top-5 w-full'>
            ...
            <div className='flex justify-center gap-x-6 mt-6 lg:mt- mb-9'>

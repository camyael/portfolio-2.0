...
const Banner = () => (
    <div id='banner' className="mt-[6rem] h-[70vh] md:h-[80vh] relative pt-9">
        <div className="h-[100%] bg-moon bg-cover bg-top mix-blend-screen">
        </div>
        <div className='absolute top-5 w-full'>
            <div className='w-1/12 mb-[-3%] ml-[80%] md:ml-[70%]'>
                <img className='text-end' width={75} src={start}/>
            </div>
            <img className='w-full md:w-2/4 mx-auto' src={banner}/>
            <div className='text-pink-secondary text-center font-semibold italic w-1/12 mt-[-8%] ml-[20%] md:ml-[32%]'>
                <span>&</span>
                <p>Diseñadora</p>
                <p>UX/UI</p>
            </div>
            <div className='w-1/12 ml-[10%] md:ml-[25%]'>
                <img width={75} src={start}/>
            </div>
            <p className='w-full md:w-2/6 my-10 md:my-0 px-8 text-center mx-auto text-[1rem] tracking-tighter'>Desarrolladora apasionada en crear experiencias que sean atractivas, accesibles y centradas en el usuario.</p>
